...
Final_APR = r"path\APR\APR Current Model Prev Month.xlsx"
...
wb = xlapp.workbooks.open(Final_APR)
...
print("The Final APR is refreshed and saved.")
...
To = r"path\APR\Daily Reports\APR " + convert_to_str + " Final.xlsx"
shutil.copy(From, To)
print("APR final is saved in the Daily Reports from your Documents folder.")
