...
# The purpose of this script is to dynamically move the Raw data spit out by Alteryx to the public folder.
    ...
    #Public folder: another_path\Raw Data
...
# To files
#To = rb"another_path\Raw Data\ " + today.strftime("%Y-%m")
This_month = today.strftime("%Y-%m")
print(This_month)
To = r"another_path\Raw Data\2022-06"
print("Moving raw data files for Final.")
...
os.rename(r"another_path\Raw Data\2022-06\Previous Month Calls Raw Data.csv", 
          r"another_path\Raw Data\2022-06\Calls Data " + convert_to_str + " Final.csv") #yyyy-mm-dd)
print("Calls renamed")
os.rename(r"another_path\Raw Data\2022-06\Previous Month Bonus Raw Data.csv", 
          r"another_path\Raw Data\2022-06\Bonus Data " + convert_to_str + " Final.csv") #yyyy-mm-dd)
print("Bonus renamed")
os.rename(r"another_path\Raw Data\2022-06\Previous Month Saves Raw Data.csv", 
          r"another_path\Raw Data\2022-06\Saves Data " + convert_to_str + " Final.csv") #yyyy-mm-dd
print("Saves renamed")
